...
export default function Product({
    ...
    <form onSubmit={createProduct} className="mx-auto max-w-screen-sm">
        ...
        <div>
            <label for="example1" class="mb-1 block text-lg font-medium text-gray-700">Title</label>
        ...
        <div class="mx-auto my-4">
        <div>
            <label for="example1" class="mb-1 block text-lg font-medium text-gray-700">Select Category</label>
        ...
        <div class="mx-auto">
        <label for="example1" class="mb-1 block text-lg font-medium text-gray-700">Images</label>
        ...
        <div className="grid grid-cols-2 items-center rounded">
            {isUploading && (
                <Spinner className="p-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
