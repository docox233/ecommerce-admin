...
export default function Home() {
  ...
  <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <div className="text-center sm:text-left">
        ...
        <p className="mt-1.5 text-md text-gray-500 max-w-lg">View the statistics about your bussiness. Also manage and add products. 🎉</p>
      </div>
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen justify-center items-center max-w-4xl m-auto">
      <h1 className="text-4xl font-bold max-w-lg text-center">Welcome to the admin 
      of the website</h1>
